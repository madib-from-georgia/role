...
import CharacterChecklistsV2 from './pages/CharacterChecklistsV2'
import CharacterChecklistDetailV2 from './pages/CharacterChecklistDetailV2'
import { DesignToggle, useDesignVersion } from './components_v2/common/DesignToggle'
        ...
        <main className="main-content">
          <Routes>
            ...
            <Route 
              ...
              element={
                <ProtectedRoute>
                  {isV2 ? <CharacterChecklistsV2 /> : <CharacterChecklists />}
                </ProtectedRoute>
              } 
            />
            <Route 
              ...
              element={
                <ProtectedRoute>
                  {isV2 ? <CharacterChecklistDetailV2 /> : <CharacterChecklistDetail />}
                </ProtectedRoute>
              } 
            />
          </Routes>
