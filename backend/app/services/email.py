...
class EmailService:
    ...
    def send_password_reset_email(self, to_email: str, reset_token: str, user_name: str = None) -> bool:
        ...
        <head>
            <meta charset="utf-8">
            <title>Сброс пароля - Анализ Персонажей</title>
            <style>
                body {{
        ...
        <body>
            ...
            <div class="content">
                ...
                <p>Вы запросили сброс пароля для вашего аккаунта в системе "Анализ Персонажей".</p>
                ...
                <div class="footer">
                    <p>С уважением,<br>Команда "Анализ Персонажей"</p>
        ...
        text_content = f"""
        Сброс пароля - Анализ Персонажей
        
        Здравствуйте, {display_name}!
        
        Вы запросили сброс пароля для вашего аккаунта в системе "Анализ Персонажей".
        ...
        С уважением,
        Команда "Анализ Персонажей"
        
        Это автоматическое письмо, не отвечайте на него.
        """
        
        subject = "Сброс пароля - Анализ Персонажей"
    ...
    def send_password_changed_notification(self, to_email: str, user_name: str = None) -> bool:
        ...
        <head>
            <meta charset="utf-8">
            <title>Пароль изменен - Анализ Персонажей</title>
            <style>
                body {{
                    font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
                    line-height: 1.6;
        ...
        text_content = f"""
        Пароль изменен - Анализ Персонажей
        ...
        subject = "Пароль изменен - Анализ Персонажей"
